...
public class AttributeMetadata {
    ...
    public final Class<?> liveObjectClass;
    public final Class<? extends Enum<?>> enumClass;
    public final LanguageText labelText;
    public final boolean required;

    public AttributeMetadata(String attributeVariableName, Class<? extends Attribute<?, ?>> attributeClass, Class<? extends FactoryBase<?, ?>> referenceClass, Class<?> liveObjectClass, Class<? extends Enum<?>> enumClass, LanguageText labelText, boolean required) {
