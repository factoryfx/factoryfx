...
public class ParametrizedObjectCreatorAttribute<R extends FactoryBase<?,R>,P, L, F extends ParametrizedObjectCreatorFactory<P,L,R>> extends FactoryBaseAttribute<ParametrizedObjectCreator<P,L>,F,ParametrizedObjectCreatorAttribute<R,P, L, F>> {
