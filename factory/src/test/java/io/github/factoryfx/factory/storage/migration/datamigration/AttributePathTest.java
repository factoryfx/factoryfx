...
public class AttributePathTest {
    ...
    public void test_resolve_string_root_attribute(){
        ...
        assertEquals("1234",PathBuilder.value(String.class).attribute("stringAttribute").resolveAttributeValue(new DataJsonNode((ObjectNode)ObjectMapperBuilder.build().writeValueAsTree(exampleDataA)),ObjectMapperBuilder.build()));
    }
    ...
    public void test_remove_path_check(){
        ...
        assertTrue(PathBuilder.value(ExampleDataA.class).attribute("garbage").isPathToRemovedAttribute(dictionary));
    }
    ...
    public void test_resolve_reflist_string(){
        ...
        assertEquals("1234",PathBuilder.value(String.class).pathElement("referenceListAttribute",1).attribute("stringAttribute").resolveAttributeValue(new DataJsonNode((ObjectNode)ObjectMapperBuilder.build().writeValueAsTree(exampleDataA)),ObjectMapperBuilder.build()));
    }
