...
public class FileSystemFactoryStorageHistoryTest {
    ...
    public void test_empty() throws MalformedURLException {
        FileSystemFactoryStorageHistory<Void,ExampleLiveObjectA,ExampleFactoryA> fileSystemFactoryStorage = new FileSystemFactoryStorageHistory<>(Paths.get(folder.getRoot().toURI()),createSerialisation());
    ...
    public void test_restore() throws MalformedURLException {
        ...
        FileSystemFactoryStorageHistory<Void,ExampleLiveObjectA,ExampleFactoryA> restored = new FileSystemFactoryStorageHistory<>(Paths.get(folder.getRoot().toURI()),createSerialisation());
