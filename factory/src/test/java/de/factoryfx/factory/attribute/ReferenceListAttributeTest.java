...
public class ReferenceListAttributeTest {
    ...
    public static class ExampleReferenceListFactory extends FactoryBase<VoidLiveObject,ExampleReferenceListFactory> {
        public ReferenceListAttribute<ExampleLiveObjectA,ExampleFactoryA> referenceListAttribute =new ReferenceListAttribute<>(ExampleFactoryA.class,new AttributeMetadata());
