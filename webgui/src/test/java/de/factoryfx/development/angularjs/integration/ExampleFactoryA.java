...
import de.factoryfx.factory.attribute.GenericValueAttribute;
...
public class ExampleFactoryA extends FactoryBase<ExampleLiveObjectA,ExampleFactoryA> {
    ...
    public final EnumAttribute enumAttribute=new EnumAttribute(new AttributeMetadata().en("EnumAttribute").de("ExampleA1ger"));
    public final GenericValueAttribute genericValueAttribute=new GenericValueAttribute(new AttributeMetadata().en("GenericValueAttribute").de("ExampleA1ger"));
