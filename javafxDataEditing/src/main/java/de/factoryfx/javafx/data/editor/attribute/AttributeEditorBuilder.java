...
import de.factoryfx.javafx.data.editor.attribute.visualisation.Base64AttributeVisualisation;
...
import de.factoryfx.javafx.data.editor.attribute.visualisation.CatalogAttributeVisualisation;
...
import de.factoryfx.javafx.data.editor.attribute.visualisation.EnumListAttributeVisualisation;
...
import de.factoryfx.javafx.data.editor.attribute.visualisation.ShortAttributeVisualisation;
...
public class AttributeEditorBuilder {
    ...
    public static List<Function<UniformDesign,SingleAttributeEditorBuilder<?>>> createDefaultSingleAttributeEditorBuildersFunctions(){
        ...
        result.add(uniformDesign->new SimpleSingleAttributeEditorBuilder<>(uniformDesign,BooleanAttribute.class,Boolean.class,(attribute)-> new BooleanAttributeVisualisation(attribute.internal_isUserReadOnly()), BooleanAttribute::new));
        ...
        result.add(uniformDesign->new SingleAttributeEditorBuilder<Data>(){
            ...
            public AttributeEditor<Data, ?> createEditor(Attribute<?, ?> attribute, Consumer<Data> navigateToData, Data previousData) {
                ...
                if(referenceAttribute.internal_isCatalogueBased()){
                    return new AttributeEditor<>(referenceAttribute, new CatalogAttributeVisualisation(referenceAttribute::internal_possibleValues, referenceAttribute.internal_isUserReadOnly()), uniformDesign);
                } else {
