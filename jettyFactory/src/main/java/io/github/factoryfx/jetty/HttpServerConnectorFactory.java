...
public class HttpServerConnectorFactory<R extends FactoryBase<?,R>> extends SimpleFactoryBase<HttpServerConnector,R> {
    ...
    public final FactoryReferenceAttribute<R,SslContextFactory, SslContextFactoryFactory<R>> ssl = new FactoryReferenceAttribute<R,SslContextFactory, SslContextFactoryFactory<R>>().de("ssl").en("ssl").nullable();
