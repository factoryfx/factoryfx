...
public class HttpServerConnectorFactory<R extends FactoryBase<?,R>> extends SimpleFactoryBase<HttpServerConnector,R> {
    ...
    public final FactoryAttribute<SslContextFactory.Server, ServerSslContextFactoryFactory<R>> ssl = new FactoryAttribute<SslContextFactory.Server, ServerSslContextFactoryFactory<R>>().de("ssl").en("ssl").nullable();
