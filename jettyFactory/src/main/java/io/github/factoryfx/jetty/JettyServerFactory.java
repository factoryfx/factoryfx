...
public class JettyServerFactory<R extends FactoryBase<?, R>> extends FactoryBase<Server, R> {
    ...
    public final FactoryListAttribute<HttpServerConnector, HttpServerConnectorFactory<R>> connectors =
        new FactoryListAttribute<HttpServerConnector, HttpServerConnectorFactory<R>>().labelText("Connectors").userNotSelectable();
    public final FactoryAttribute<ContextHandlerCollection, HandlerCollectionFactory<R>> handler =
        new FactoryAttribute<ContextHandlerCollection, HandlerCollectionFactory<R>>().labelText("Handler collection");
    public final FactoryPolymorphicAttribute<ThreadPool> threadPool =
