    ...
    static {
        ...
        FastFactoryUtility.setup(FastExampleFactoryB.class,
                new FastFactoryUtility<>(() -> List.of(
                        ...
                        new FastFactoryAttribute<>(()->new FactoryAttribute<ExampleLiveObjectA, FastExampleFactoryA>().labelText("ExampleA2"), (factory) -> factory.referenceAttribute, (factory, value) -> factory.referenceAttribute = value, FastExampleFactoryA.class,ExampleLiveObjectA.class,"referenceAttribute"),
                        new FastFactoryAttribute<>(()->new FactoryAttribute<ExampleLiveObjectC, FastExampleFactoryC>().labelText("ExampleA3"), (factory) -> factory.referenceAttributeC, (factory, value) -> factory.referenceAttributeC = value, FastExampleFactoryC.class,ExampleLiveObjectC.class,"referenceAttributeC")
        )));
    }
