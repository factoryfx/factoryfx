...
public class ExampleFactoryC extends SimpleFactoryBase<ExampleLiveObjectC,ExampleFactoryA> {
    ...
    public final FactoryAttribute<ExampleLiveObjectB,ExampleFactoryB> referenceAttribute = new FactoryAttribute<ExampleLiveObjectB,ExampleFactoryB>().labelText("ExampleA2");
