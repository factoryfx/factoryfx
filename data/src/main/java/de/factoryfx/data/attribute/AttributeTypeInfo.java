...
public class AttributeTypeInfo {
    ...
    public AttributeTypeInfo(Class<?> dataType, Class<?> mapKeyType, Class<?> mapValueType, AttributeTypeCategory attributeType) {
        this(dataType,mapKeyType,mapValueType,null,attributeType);
    }

    public AttributeTypeInfo(Class<?> dataType, Class<?> mapKeyType, Class<?> mapValueType, Class<?> listItemType, AttributeTypeCategory attributeType) {
    ...
    public AttributeTypeInfo(Class<?> dataType) {
        this(dataType,null,null,null,AttributeTypeCategory.VALUE);
    }
