...
public class MigrationManagerTest {
    ...
    public void test_renameAttribute() {
        ...
        String oldDictionary =   "{\n" +
                                 ...
                                 "      \"attributeClassName\" : \"io.github.factoryfx.data.attribute.types.StringAttribute\"\n" +
                                 "    }, {\n" +
                                 "      \"variableName\" : \"referenceAttribute\",\n" +
                                 "      \"attributeClassName\" : \"io.github.factoryfx.data.attribute.DataReferenceAttribute\"\n" +
                                 "    }, {\n" +
                                 "      \"variableName\" : \"referenceListAttribute\",\n" +
                                 "      \"attributeClassName\" : \"io.github.factoryfx.data.attribute.DataReferenceListAttribute\"\n" +
                                 "    } ],\n" +
                                 "    \"className\" : \"io.github.factoryfx.data.merge.testdata.ExampleDataA\"\n" +
                                 "  }, {\n" +
                                 "    \"attributes\" : [ {\n" +
                                 ...
                                 "      \"attributeClassName\" : \"io.github.factoryfx.data.attribute.DataReferenceAttribute\"\n" +
                                 "    } ],\n" +
                                 "    \"className\" : \"io.github.factoryfx.data.merge.testdata.ExampleDataB\"\n" +
                                 "  }, {\n" +
                                 "    \"attributes\" : [ {\n" +
                                 "      \"variableName\" : \"stringAttribute\",\n" +
                                 "      \"attributeClassName\" : \"io.github.factoryfx.data.attribute.types.StringAttribute\"\n" +
                                 "    } ],\n" +
                                 "    \"className\" : \"io.github.factoryfx.data.merge.testdata.ExampleDataC\"\n" +
                                 "  } ]\n" +
                                 "}";
    ...
    public void read_renameClass() {
        ...
        String oldDictionary =   "{\n" +
                ...
                "      \"attributeClassName\" : \"io.github.factoryfx.data.attribute.DataReferenceListAttribute\"\n" +
                "    } ],\n" +
                "    \"className\" : \"io.github.factoryfx.data.merge.testdata.WrongNameExampleDataA\"\n" +//<======
                "  }, {\n" +
                "    \"attributes\" : [ {\n" +
                "      \"variableName\" : \"stringAttribute\",\n" +
                "      \"attributeClassName\" : \"io.github.factoryfx.data.attribute.types.StringAttribute\"\n" +
        ...
        String input =
                "{\n" +
                "  \"@class\" : \"io.github.factoryfx.data.merge.testdata.WrongNameExampleDataA\",\n" +//<======
                "  \"id\" : \"d2412cc8-c759-58f5-93f8-ef4e195114b5\",\n" +
                "  \"stringAttribute\" : {\n" +
                "    \"v\" : \"123\"\n" +
                "  },\n" +
        ...
        MigrationManager<ExampleDataA,Void> manager = new MigrationManager<>(ExampleDataA.class, ObjectMapperBuilder.build(), (root1, oldDataStorageMetadataDictionary) -> { });
        manager.renameClass("io.github.factoryfx.data.merge.testdata.WrongNameExampleDataA",ExampleDataA.class);
        ExampleDataA result = manager.read(input,ObjectMapperBuilder.build().readValue(oldDictionary,DataStorageMetadataDictionary.class));
        Assertions.assertEquals("123",result.stringAttribute.get());
    }
