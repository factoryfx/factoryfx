package io.github.factoryfx.javafx.factory.widget.validation;
...
public class ValidationWidget implements Widget {
    ...
    public ValidationWidget(FactoryBase<?,?> root, DataEditor dataEditor, UniformDesign uniformDesign){
        this.root = root;
    ...
    private static class ValidationAndData{
        ...
        public ValidationAndData(ValidationError validationError, FactoryBase<?,?> data, String dataDisplayText) {
...
//        SplitPane.setResizableWithParent(vBox, Boolean.TRUE);
    ...
    private void validate(TreeTableView<ValidationAndData> tableView){
        ...
        for (FactoryBase<?,?> data: this.root.internal().collectChildrenDeep()){
